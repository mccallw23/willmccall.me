...
A fun challenge of this website design involved integrating particle demonstration at the top of the page to trace my personal logo.  I was able to accomplish this by integrating particles.js and altering its paramters.  For more info see https://github.com/VincentGarreau/particles.js: 
...
# Timeline:
For more info on the timeline code, reference: 
https://github.com/anbasile/pickmeup.

# RVM/Jekyll:
for more info on jekyll framework documentation/setting up jekyll see:
https://jekyllrb.com/docs/

Note: The latest version of ruby (3.0.2) as of Oct 12, 2021 does not fully support Jekyll.  As a result this project was created using Ruby version 2.7.1, which I installed and managed through ruby version manager:
